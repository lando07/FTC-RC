...
public class PrimaryMeepMeep {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(-17.2, 60, Math.toRadians(-90)))
                ...
                .splineToLinearHeading(new Pose2d(new Vector2d(3, 35.2 + 2), Math.toRadians(270)), Math.toRadians(315))
                .strafeToLinearHeading(new Vector2d(3, 35.2), Math.toRadians(270))

                .waitSeconds(.1)

                .setTangent(Math.toRadians(135))
                .splineToLinearHeading(new Pose2d(new Vector2d(-45, 58), Math.toRadians(90)), Math.toRadians(135))
                ...
                .setTangent(Math.toRadians(135))
                .splineToLinearHeading(new Pose2d(new Vector2d(-45, 58), Math.toRadians(135)), Math.toRadians(90))

                .waitSeconds(.1)

                .setTangent(Math.toRadians(315))
                .splineToLinearHeading(new Pose2d(new Vector2d(-3, 36), Math.toRadians(270)), Math.toRadians(315))
